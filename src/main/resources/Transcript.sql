...
INSERT INTO user (username, password, role) VALUES("user2", "user123", "USER");
...
INSERT INTO vehicles VALUES("Car",3);
INSERT INTO vehicles VALUES("2-Wheeler",5);
INSERT INTO vehicles VALUES("Load Carrier",7);
INSERT INTO vehicles VALUES("Van",4);
INSERT INTO vehicles VALUES("Bus",3);
INSERT INTO vehicles VALUES("Truck",6);
...
r_id int,
status varchar(20),
constraint fk_booking_user foreign key(u_id) references user(id),
constraint fk_booking_review foreign key(r_id) references Review(rid),
constraint fk_booking_payment foreign key(p_id) references Payment(pid)
);

/* Database for maintaining every Indian City longititude and Latitude */
...
INSERT INTO `cities` (`cid`, `city`, `latitude`, `longitude`, `state`) VALUES
...
(150, 'Dabgram', '23.68 N', '88.30 E', 'West Bengal'),
...
(160, 'Gopalpur', '19.26 N', '84.86 E', 'West Bengal'),
...
(182, 'Kharia', '29.13 N', '75.51 E', 'West Bengal'),
...
(196, 'Old Maldah', '25.05 N', '88.13 E', 'West Bengal'),
...
(228, 'Kolkata', '22.57 N', '88.36 E', 'West Bengal'),
...
(233, 'Goura', '22.51 N', '87.75 E', 'Bihar'),
(234, 'Hajipur', '25.69 N', '85.20 E', 'Bihar'),
...
(275, 'Burari', '28.75 N', '77.19 E', 'Delhi'),
(276, 'Chilla', '25.76 N', '80.52 E', 'Delhi'),
(277, 'Dallo Pura', '28.60 N', '77.31 E', 'Delhi'),
(278, 'Delhi', '28.67 N', '77.21 E', 'Delhi'),
(279, 'Deoli', '28.49 N', '77.22 E', 'Delhi'),
(280, 'Dilli Cantonment', '28.57 N', '77.16 E', 'Delhi'),
(281, 'Gharoli', '28.61 N', '77.33 E', 'Delhi'),
...
(967, 'Meerut', '28.98 N', '77.70 E', 'Uttar Pradesh'),
...
(982, 'Indirapuram', '2864 N', '77.36 E', 'Uttar Pradesh'),
